...
_SPLITS_COCO_FORMAT["coco"] = {
    ...
    'bdd100k_train_unlabel': (
        '/app/datasets/bdd100k/train',
        '/app/datasets/bdd100k/train_night.json'),
...
register_coco_instances('bdd100k_coco_train', {},
                        '/app/datasets/bdd100k/train_day.json',
                       '/app/datasets/bdd100k/train')

register_coco_instances('bdd100k_coco_val', {},
                        '/app/datasets/bdd100k/val_night.json',
                       '/app/datasets/bdd100k/val')
